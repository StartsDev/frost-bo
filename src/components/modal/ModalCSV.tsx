<<<<<<< HEAD:bo/src/components/modal/ModalCSV.tsx
    ...
    const handleClickCSV = () => {
        if (startDate && endDate) {
                ...
                if (filteredItems && filteredItems.length > 0) {
                    ...
                    const link = document.createElement('a');
                    link.href = url;
                    link.setAttribute('download', `${moduleName}_fecha.csv`);
                    link.click();
                    setStartDate('');
                    setEndDate('');
                }
...
export default ModalCSV;
>>>>>>> aa7a6e2f85b4480d6878d122eb99121e42382b3e:src/components/modal/ModalCSV.tsx
